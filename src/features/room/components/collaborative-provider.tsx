...
import { type ConnectionStatus, type RoomError, useCollaboration } from "@/hooks/useCollaboration";
...
const CollaborativeSessionContext = createContext<CollaborativeContextValue | null>(null);
...
export const useCollaborationSession = () => {
  ...
  if (!context) {
    throw new Error("useCollaborationSession must be used inside CollaborationSessionProvider");
  }
  return context;
};
