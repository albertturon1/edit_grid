...
export type ButtonFileUploaderProps = Omit<FilePickerCoreProps, "onFileImport" | "ref"> & {
  className?: string;
  onFileImport: (data: FileImportResult) => void;
};

export function ButtonFileUploader({ options, onFileImport, className }: ButtonFileUploaderProps) {
