...
import { LiveCollaborationDialog } from "./live-collaboration-dialog";

type VisibleDialog = "export" | "live_collaboration";
...
export function FileDropdownMenu({
  ...
  function handleOpenLiveCollaboration() {
    setVisibleDialog("live_collaboration");
  }
  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen}>
      ...
      <DropdownMenuContent className="flex flex-col" align="start">
        ...
        <DropdownMenuItem
          className="gap-x-2 py-2"
          onClick={handleOpenLiveCollaboration}
        >
          {"Live collaboration"}
        </DropdownMenuItem>
      </DropdownMenuContent>
      ...
      <ExportDialog
        ...
        open={visibleDialog === "export"}
        onSubmit={handleExportDialogSubmit}
        headers={headers}
        onOpenChange={closeDialog}
        onCancel={closeDialog}
      />
      <LiveCollaborationDialog
        open={visibleDialog === "live_collaboration"}
        onOpenChange={closeDialog}
        onCancel={closeDialog}
        headers={headers}
